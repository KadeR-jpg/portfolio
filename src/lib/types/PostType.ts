export type Tags = 'svelte' | 'talking' | 'random' | 'ai' | 'music';
export const tagClasses: Record<string, string> = {
  ...
  music: 'bg-lime-50 text-lime-600 dark:bg-lime-300 dark:text-lime-800',
  ai: 'bg-fuchsia-50 text-fuchsia-600 dark:bg-fuchsia-300 dark:text-fuchsia-800'
};
export type Post = {
  title: string;
  slug: string;
